      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-white/[0.04] px-4 py-2 text-sm text-muted">
            ...
            Conçu pour un progrès cohérent et mesurable
          </div>
          <h1 className="mt-7 max-w-3xl text-5xl font-semibold leading-[0.98] tracking-normal text-white sm:text-6xl lg:text-7xl">
            L'expérience premium pour transformer votre corps.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-muted sm:text-xl">
            Programmes d'entraînement, nutrition, suivi de progression et coaching IA — tout en un.
          </p>
    ...
    <section className="px-5 py-24 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <SectionHeader
          ...
          title="Du premier check-in aux progrès visibles."
          description="Une configuration guidée transforme votre objectif et disponibilité en un plan réalisable."
        />
    ...
    <section className="px-5 pb-10 pt-16 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-border bg-card p-8 shadow-card sm:p-12">
        <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
          <div>
            <p className="text-sm font-medium uppercase tracking-[0.18em] text-accent">Prêt·e à commencer</p>
            <h2 className="mt-4 max-w-2xl text-3xl font-semibold leading-tight sm:text-5xl">
              Construisez le corps que votre routine peut soutenir.
            </h2>
          </div>
          <AppButton icon={<ArrowRight className="h-4 w-4" />}>Commencer gratuitement</AppButton>
        </div>
      </div>
    </section>
  );
